            ...
            <tr>
              <th class="py-2" scope="col">
                <div class="table-row table-row-content">
                  ...
                  <a
                    href="mailto:kamlesh.kumar@teleglobals.com"
                    target="_newEmail"
                    style={{ wordBreak: "break-all" }}
                  >
                    <h5 style={{ fontFamily: "Arial" }}>
                      kamlesh.kumar@teleglobals.com
                    </h5>
                  </a>
                </div>
              </th>
            ...
            <tr>
              <th class="py-2" scope="col">
                <div class="table-row table-row-content">
                  ...
                  <small style={{ color: "#b3b4bb" }}>Managing Director</small>
            ...
            <tr>
              <th class="py-2" scope="col">
                <div class="table-row table-row-content">
                  ...
                  <h5>
                    Cerebrum IT Park, B-3, Office No. - 4B, Survey No.13B,
                    Kalyani Nagar<br></br>
                    Pune, Maharashtra 411014<br></br>
                    India
                  </h5>
                </div>
              </th>
